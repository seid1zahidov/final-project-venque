...
const Community4update = () => {
    ...
    useEffect(() => {
        const fetcHandler = async () => {
            await axios.get(`http://localhost:3002/Community4/${id}`)
                .then(res => res.data)
                .then(data => Setinputs(data.com4))
    ...
    const sendRequest = async () => {
        await axios.put(`http://localhost:3002/Community4/${id}`, {
            image: String(inputs.image),
        }).then(res => res.data.com4)
    }
...
export default Community4update