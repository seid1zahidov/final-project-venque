...
const Community10update = () => {
    ...
    useEffect(() => {
      const fetcHandler = async () => {
        await axios.get(`http://localhost:3002/Community10/${id}`)
          .then(res => res.data)
          .then(data => Setinputs(data.com9))
    ...
    const sendRequest = async () => {
      await axios.put(`http://localhost:3002/Community10/${id}`, {
        image: String(inputs.image),
      }).then(res => res.data.com9)
    }
...
export default Community10update