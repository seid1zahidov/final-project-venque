...
const Community7update = () => {
    ...
    useEffect(() => {
      const fetcHandler = async () => {
        await axios.get(`http://localhost:3002/Community7/${id}`)
          .then(res => res.data)
          .then(data => Setinputs(data.com7))
    ...
    const sendRequest = async () => {
      await axios.put(`http://localhost:3002/Community7/${id}`, {
        image: String(inputs.image),
      }).then(res => res.data.com7)
    }
...
export default Community7update